...
class Blocks(paddle.nn.Layer):
    ...
    def forward(self, x0):
        ...
        x8 = self.block100(x7, x6, x5, x4, x3, x2, x1)
        x9 = self.block10(x8, x6, x5, x4, x3, x2, x1)
        x10 = self.block50(x9, x6, x5, x4, x3, x2, x1)
        x11 = self.block00(x10, x6, x5, x4, x3, x2, x1)
        x12 = self.block60(x11, x6, x5, x4, x3, x2, x1)
        x13 = self.block110(x12, x6, x5, x4, x3, x2, x1)
        x14 = self.block30(x13, x6, x5, x4, x3, x2, x1)
        x15 = self.block90(x14, x6, x5, x4, x3, x2, x1)
        x16 = self.block40(x15, x6, x5, x4, x3, x2, x1)
        x17 = self.block70(x16, x6, x5, x4, x3, x2, x1)
        x18 = self.block20(x17, x6, x5, x4, x3, x2, x1)
        return x18
...
class VisionTransformer(paddle.nn.Layer):
    def __init__(self, ):
        ...
        self.x6 = self.create_parameter(dtype='float32', shape=(1, 1, 197, 192), default_initializer=paddle.nn.initializer.Constant(value=0.0))
        self.dropout0 = paddle.nn.Dropout(p=0.0)
        self.blocks0 = Blocks()
        self.layernorm0 = paddle.nn.LayerNorm(normalized_shape=[192], epsilon=1e-06)
...
def main(x0):
    ...
    params = paddle.load('E:/dataFiles/github/PaddleTr/x2paddle/pd_model_trace/model.pdparams')
